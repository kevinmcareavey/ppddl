...
public class UnionType extends Type {
	...
	public UnionType(List<SimpleType> simpleTypes) throws Exception {
		if(simpleTypes.isEmpty()) {
			throw new Exception("union type is empty");
		}
		this.setSimpleTypes(simpleTypes);
	}
	
	public UnionType(SimpleType... simpleTypes) throws Exception {
